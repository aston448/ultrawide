...
class UpdateComponentVerificationsClass {
    ...
    componentIsRemovedElsewhereForDesigner(componentType, parentName, componentName){
        server.call('verifyDesignUpdateComponents.componentIsRemovedElsewhere', componentType, parentName, componentName, 'gloria',
            (function(error, result){
                return(error === null);
            })
        );
...
export const UpdateComponentVerifications = new UpdateComponentVerificationsClass();
