...
class ClientDesignUpdateComponentServicesClass{
    ...
    updateComponentName(view, mode, designUpdateComponent, newPlainText, newRawText){
        ...
        if(designUpdateComponent.componentNameNew === newPlainText){
    ...
    addDesignSectionToApplication(view, mode, parentComponent){
        ...
        // Client validation
        let result = DesignUpdateComponentValidationApi.validateAddDesignUpdateComponent(view, mode, parentComponent, ComponentType.DESIGN_SECTION);
    ...
    addFeatureToDesignSection(view, mode, parentComponent){
        ...
        // Client validation
        let result = DesignUpdateComponentValidationApi.validateAddDesignUpdateComponent(view, mode, parentComponent, ComponentType.FEATURE);
    ...
    toggleInScope(view, mode, displayContext, baseComponent, designUpdateId, updateComponent, newScope){
        ...
        ServerDesignUpdateComponentApi.toggleScope(view, mode, displayContext, baseComponent._id, designUpdateId, updateComponent, newScope, (err, result) => {
            ...
            if(err){
                ...
                // Get all parents of changing item so we can update their scope
                ...
                store.dispatch(setUpdateScopeItems(
                    {
                        ...
                        changingItemId: baseComponent._id,
