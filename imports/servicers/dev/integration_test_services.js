...
class IntegrationTestServices {
    ...
    getIntegrationTestResults(testType, userContext){
        ...
        if(designApplications.length > 0){
            ...
            designApplications.forEach((application) => {
                ...
                this.getDesignSubSectionFeatures(resultsData, userContext, application, featureIndex);
    ...
    getDesignSubSectionFeatures(resultsData, userContext, parentComponent, featureIndex){
        ...
        if(subsections.length > 0){
            ...
            subsections.forEach((subsection) => {
                ...
                currentFeatureIndex = this.processFeatures(resultsData, userContext, features, currentFeatureIndex);

                // Recursively look for deeper features
                this.getDesignSubSectionFeatures(resultsData, userContext, subsection, currentFeatureIndex);
            })
        }
    };

    processFeatures(resultsData, userContext, features, featureIndex){
        ...
        features.forEach((feature) => {
            ...
            log((msg) => console.log(msg), LogLevel.DEBUG, "Processing Mash Data for Feature {}", feature.componentName);
