/**
 * Feature Background Step Data Store.  This is common background conditions for all Scenarios in a Feature
 */
...
export const FeatureBackgroundSteps = new Mongo.Collection('featureBackgroundSteps');

let Schema = new SimpleSchema({
    // Identity
    stepReferenceId:            {type: String},                                     // A unique ID that persists across design updates
    componentType:              {type: String, defaultValue: ComponentType.BACKGROUND_STEP},  // Provides a common identifier with other design components
    ...
    featureReferenceId:         {type: String},                                     // Reference to the Feature for which this is the background
...
FeatureBackgroundSteps.attachSchema(Schema);
