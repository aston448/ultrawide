...
import { DesignEditorHeader }   from '../DesignEditorHeader';          // Non Redux
...
describe('JSX: DesignEditorHeader', () => {
    ...
    describe('There is no option to switch to editing mode when a Design Version is being viewed', () => {
        ...
        it('a view only design has no edit button', () => {
            ...
            const userRole = RoleType.MANAGER;  // Must not be Designer as Desainer always has option to go to Edit mode if Design is editable
