...
describe('UC 145 - Move Design Component', function(){
    ...
    describe('Conditions', function(){
        ...
        describe('Applications cannot be moved', function(){

            it('cannot move to Component Type - Application', function(){
                ...
                const expectation = {success: false, message: DesignComponentValidationErrors.DESIGN_COMPONENT_INVALID_MOVE};
            ...
            it('cannot move to Component Type - Design Section', function(){
            ...
            it('cannot move to Component Type - Feature', function(){
            ...
            it('cannot move to Component Type - Aspect', function(){
            ...
            it('cannot move to Component Type - Scenario', function(){

                DesignActions.designerWorksOnDesign('Design1');
                DesignVersionActions.designerEditsDesignVersion('DesignVersion1');

                // Execute - try to move Application1 to Scenario1
                DesignComponentActions.designerSelectsComponentType_WithParent_Called_(ComponentType.APPLICATION, 'NONE', 'Application1');
                const expectation = {success: false, message: DesignComponentValidationErrors.DESIGN_COMPONENT_INVALID_MOVE};
        ...
        describe('Design Sections can only be moved to Applications or other Design Sections', function(){
            ...
            it('cannot move to Component Type - Scenario', function(){
                ...
                // Execute - try to move Section1 to Scenario1
                DesignComponentActions.designerSelectsComponentType_WithParent_Called_(ComponentType.DESIGN_SECTION, 'Application1', 'Section1');
                const expectation = {success: false, message: DesignComponentValidationErrors.DESIGN_COMPONENT_INVALID_MOVE};
                DesignComponentActions.designerMovesSelectedComponentToTarget_WithParent_Called_(ComponentType.SCENARIO, 'Actions', 'Scenario1', expectation);
        ...
        describe('Features can only be moved to Design Sections', function(){
            ...
            it('cannot move to Component Type - Scenario', function(){
                ...
                // Execute - try to move Feature1 to Scenario3 of Feature2 Actions
                DesignComponentActions.designerSelectsComponentType_WithParent_Called_(ComponentType.FEATURE, 'Section1', 'Feature1');
                const expectation = {success: false, message: DesignComponentValidationErrors.DESIGN_COMPONENT_INVALID_MOVE};
                DesignComponentActions.designerMovesSelectedComponentToTarget_WithParent_Called_(ComponentType.SCENARIO, 'Actions', 'Scenario3', expectation);
        ...
        describe('Feature Aspects cannot be moved', function(){
            ...
            it('cannot move to Component Type - Scenario', function(){
                ...
                // Execute - try to move Aspect Actions to Scenario4
                DesignComponentActions.designerSelectsComponentType_WithParent_Called_(ComponentType.FEATURE_ASPECT, 'Feature1', 'Actions');
                const expectation = {success: false, message: DesignComponentValidationErrors.DESIGN_COMPONENT_INVALID_MOVE};
                DesignComponentActions.designerMovesSelectedComponentToTarget_WithParent_Called_(ComponentType.SCENARIO, 'Conditions', 'Scenario4', expectation);
        ...
        describe('Scenarios can only be moved to Feature Aspects', function(){
