...
import {DesignVersionStatus, DesignUpdateStatus, UpdateMergeStatus, ComponentType, DesignUpdateMergeAction} from '../../../imports/constants/constants.js'
...
describe('UC 106 - Create New Design Version', function(){
    ...
    describe('Actions', function(){
        ...
        it('A Designer can create a new Updatable Design Version from an existing Published Design Version', function(){
    ...
    describe('Consequences', function(){
        ...
        it('When a new Design Version is created Design Updates selected for Carry Forward are now updates for the new Design Version', function(){
            ...
            // Set update to INCLUDE by publishing
            DesignUpdateActions.designerPublishesUpdate('DesignUpdate1');
            // Check
            ...
            // Set update to ROLL FORWARD after publishing
        ...
        it('When a new Design Version is created, all Test Expectations are carried forward', function(){
            // Replace this with proper test code
