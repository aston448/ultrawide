...
describe('UC 144 - Remove Design Component', function(){
    ...
    describe('Actions', function(){
        ...
        describe('A Design Component with no child components may be removed from a Design Version', function(){
            ...
            it('Component Type - Aspect', function(){
                ...
                DesignComponentActions.designerRemovesDesignComponentOfType_WithParent_Called_(ComponentType.SCENARIO, 'Actions', 'ExtraScenario');
    ...
    describe('Conditions', function(){
        ...
        describe('A Design Component may not be removed if it has any child components', function(){
            ...
            it('Component Type - Design Section', function(){
                ...
                // Execute
                let expectation = {success: false, message: DesignComponentValidationErrors.DESIGN_COMPONENT_NOT_REMOVABLE};
                ...
                // Execute
                expectation = {success: false, message: DesignComponentValidationErrors.DESIGN_COMPONENT_NOT_REMOVABLE};
