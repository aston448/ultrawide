...
describe('UC 231 - Add Design Component to Work Package Scope - Initial Design Version', function(){
    ...
    it('A Manager can add all non-scoped Scenarios for an Application in an Initial Design Version to a Work Package Scope', function(){
        ...
        // Feature1 Conditions is in scope
        ...
        // Feature2 Conditions is in scope
...
describe('UC 231 - Add Design Component to Work Package Scope - Design Update', function(){
    ...
    it('Any Scenario child of the Scope selection already in Scope for another Work Package for the same Base Design Version is not added to a Design Update Work Package Scope', function(){
        ...
        // In scope elsewhere
        expect(WpComponentVerifications.componentIsInScopeElsewhereForManagerCurrentWp(ComponentType.SCENARIO, 'Actions', 'Scenario1'));
    ...
    it('Only Design Components that are in Scope or parent Scope for a Design Update can be added to the Scope of a Design Update Work Package', function(){
        ...
        // Verify that the component is not scopable
        expect(WpComponentVerifications.componentIsNotScopableForManagerCurrentWp(ComponentType.SCENARIO, 'Actions', 'Scenario1'));
    });
